...
- Om något kan gå fel, försök göra det lätt att förstå varför.
- Hantera edge cases tydligt
- Lägg till retry-logik där det behövs

## Kommunikation
- Om det finns flera rimliga lösningar, säg kort vilken du väljer och varför.
- Om viktig information saknas för att göra det korrekt, fråga innan du gissar.
- Gör inga antaganden om krav som jag inte har sagt.
